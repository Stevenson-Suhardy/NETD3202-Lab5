...
namespace ProductSellerWebsite.Controllers
{
    public class ProductsController : Controller
    {
        ...
        {
            var context = _context.Products.Include(p => p.Seller);
        ...
        public async Task<IActionResult> Create([Bind("ProductID,Name,PricePerUnit,Year,SellerID")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductID,Name,PricePerUnit,Year,SellerID")] Product product)
        {
